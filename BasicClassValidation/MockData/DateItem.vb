Namespace MockData
    Public Class DateItem
        Public ReadOnly Property MonthIndices As List(Of String)
            Get
        ...
        Public ReadOnly Property DaysIndices As List(Of String)
            Get
        ...
        Public ReadOnly Property YearIndices As List(Of String)
            Get
